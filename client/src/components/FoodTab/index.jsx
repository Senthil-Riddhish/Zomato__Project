...
function MobileTabs() {
    //defining all the tags and mapping it together
                ...
                {allTypes.map((item) => (
                    <Link key={item.id} to={`/${item.id}`} className="w-1/4">
                        <div
                            className={
                                type === item.id
                                    ? "flex text-center flex-col relative items-center text-xl text-foodie-400"
                        ...
                        >
                            <div
                                className={
                                    type === item.id
                                        ? "w-full h-full border-t-2 p-3 border-foodie-400 flex flex-col items-center"
